...
<!-- Mirrored from new.axilthemes.com/demo/template/abstrak/onepage-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Jul 2022 15:59:54 GMT -->
<head>
    <!-- Meta Data -->
    <meta charset="UTF-8">
...
<body class="sticky-header onepage-template">
    ...
    <div id="main-wrapper" class="main-wrapper">
                ...
                <div class="container">
                    <div class="header-navbar">
                        <div class="header-logo">
                            <a href="onepage-1.html"><img class="light-version-logo" src="assets/media/logo.svg" alt="logo"></a>
                            <a href="onepage-1.html"><img class="dark-version-logo" src="assets/media/logo-3.svg" alt="logo"></a>
                            <a href="onepage-1.html"><img class="sticky-logo" src="assets/media/logo-2.svg" alt="logo"></a>
                        </div>
                    ...
                    <div class="col-xl-5 col-lg-6" data-sal="slide-right" data-sal-duration="800">
                        <div class="slick-slider slick-dot-nav featured-content" data-slick='{"infinite": true,"arrows": false, "dots": true, "slidesToShow": 1, "asNavFor": ".featured-thumbnail"}'>
                                ...
                                <div class="case-study-featured">
                                    <div class="section-heading heading-left">
                                        ...
                                        <div class="details-description">
                                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod laudantium officia itaque eligendi veritatis, porro eaque aut delectus quis et ratione? Labore dolores, voluptatum dolor, earum ullam, amet repudiandae eligendi sapiente voluptas velit praesentium quibusdam fugit quos qui explicabo. Quae voluptatibus, beatae voluptates ullam quos placeat voluptas pariatur vero qui consequatur quis consectetur rerum velit nesciunt, ipsam, delectus ut cumque? Autem vel doloremque nemo omnis veniam fuga sunt voluptatibus reprehenderit, deserunt facere consectetur non quaerat nostrum cum labore a debitis. Itaque laborum dolore voluptate. Reprehenderit itaque sequi voluptatem unde, tempora asperiores odio! Voluptate tempora praesentium veritatis quis odit eaque eligendi?</p>
                                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur blanditiis reiciendis eveniet magnam, impedit omnis unde quidem debitis id rem veniam quo vero, deleniti expedita! Illum, eum. Incidunt, aperiam placeat rerum soluta tenetur laudantium? Molestiae accusantium qui perspiciatis quos quod, possimus mollitia debitis eius, esse error velit itaque quibusdam deleniti.</p>
                                        </div>
                                    </div>
                            ...
                            <div class="slick-slide">
                                <div class="case-study-featured">
                                    <div class="section-heading heading-left">
                                        <span class="subtitle">Fitur Studi kasus</span>
                                        <h2 class="title">Website &amp; for Ditpamobvit Polda Kalimantan Barat</h2>
                                        <p>Donec metus lorem, vulputate at sapien sit amet, auctor iaculis lorem. In vel hendrerit nisi. Vestibulum eget risus velit. Aliquam tristique libero at dui sodales, et placerat orci lobortis.</p>
                                        <p>Maecenas ipsum neque, elementum id dignissim et, imperdiet vitae mauris.</p>
                                        <a href="#" class="axil-btn btn-fill-primary btn-large">Read Case Study</a>
                                        <div class="details-description">
                                    ...
                                    <div class="case-study-counterup">
                                        <div class="single-counterup">
                                            <h2 class="count-number">
                                                <span class="number count" data-count="0">-</span>
                                                <span class="symbol">%</span>
                                            </h2>
                                            <span class="counter-title">ROI increase</span>
                                        </div>
            ...
            <div class="container">
                ...
                <div class="axil-isotope-wrapper">
                    <div class="isotope-button isotope-project-btn">
                        ...
                        <button data-filter=".branding"><span class="filter-text">Web</span></button>
                        <button data-filter=".mobile"><span class="filter-text">Mobile</span></button>
                    </div>
                    <div class="row row-35 isotope-list">
                        @foreach ($portfolio as $p)
                        <div class="col-md-6 project {{ $p->type == "Web" ? "branding" : "mobile" }} branding">
                            <div class="project-grid"">
                                <div class="thumbnail">
                                    <a href="single-portfolio.html">
                                        <img src="{{ asset('storage/portfolio/'.$p->photo) }}" alt="project" class="img-fluid">
                                    </a>
                                    <img class="modal-thumb" src="assets/media/project/project-1.png" alt="Blog Post">
                                </div>
                                <div class="content">
                                    <h4 class="title"><a href="single-portfolio.html">{{ $p->title }}</a></h4>
                    ...
                    <div class="col-lg-4" data-sal="slide-up" data-sal-duration="800" data-sal-delay="100">
                        <div class="pricing-table active">
                            <div class="pricing-header">
                                ...
                                <span class="subtitle">{{ $item->package_description }}</span>
                                <div class="price-wrap">
                                    ...
                                    <div class="monthly-pricing">
                                        <span class="amount" style="font-size: 3rem">{{ number_format($item->package_price, '0') }}</span>
                            ...
                            <div class="pricing-body">
                                <ul class="list-unstyled">
                                    @foreach ($item->detailPricing as $key)
        ...
        <!--=        Blog Area Start       	    =-->
        <!--=====================================-->
        <section class="section section-padding-equal" id="op-blog">
            <div class="container">
                ...
                <div class="row g-0">
                    <div class="col-xl-6" data-sal="slide-right" data-sal-duration="800" data-sal-delay="100">
                        <div class="blog-list active">
                            <div class="post-thumbnail">
                                <a href="#"><img src="assets/media/blog/blog-1.png" alt="Blog Post"></a>
                                <img class="modal-thumb" src="assets/media/blog/blog-10.png" alt="Blog Post">
                            </div>
                            <div class="post-content">
                                <h5 class="title"><a href="#">How To Use a Remarketing Strategy To Get More</a></h5>
                                <p>Demand generation is a constant struggle for any business. Each marketing strategy you employ has generation is a constant struggle for any business. Donec metus lorem, vulputate at sapien sit amet, auctor iaculis lorem. In vel hendrerit nisi. Vestibulum eget risus velit. Aliquam tristique libero at dui sodales, et placerat orci lobortis. Maecenas ipsum neque, elementum id dignissim et, imperdiet vitae mauris.
                                    MailChimp is an email marketing service provider founded in 2001. It has 9 million users that collectively send over 15 billion emails through the service each month.</p>
                                <a href="#" class="more-btn">Learn more<i class="far fa-angle-right"></i></a>
                                <div class="details-description">
                                    <p>Demand generation is a constant struggle for any business. Each marketing strategy you employ has generation is a constant struggle for any business. Donec metus lorem, vulputate at sapien sit amet, auctor iaculis lorem. In vel hendrerit nisi. Vestibulum eget risus velit. Aliquam tristique libero at dui sodales, et placerat orci lobortis. Maecenas ipsum neque, elementum id dignissim et, imperdiet vitae mauris. MailChimp is an email marketing service provider founded in 2001. It has 9 million users that collectively send over 15 billion emails through the service each month.</p>
                    ...
                    <div class="col-xl-6" data-sal="slide-left" data-sal-duration="800" data-sal-delay="100">
                        <div class="blog-list border-start">
                            <div class="post-thumbnail">
                                <a href="#"><img src="assets/media/blog/blog-2.png" alt="Blog Post"></a>
                                <img class="modal-thumb" src="assets/media/blog/blog-11.png" alt="Blog Post">
                            </div>
                            <div class="post-content">
                                <h5 class="title"><a href="#">SEO Statistics You Should Know in 2021</a></h5>
                                <p>Organic search has the potential to capture more than 40 percent of your gross revenue Habitasse per feugiat aliquam luctus accumsan curae, suspendisse aliquam taciti eros neque, aenean sit iaculis risus commodo be universal to all small business email marketing. MailChimp is an email marketing service provider founded in 2001. It has 9 million users that collectively send over 15 billion emails through the service each month</p>
                                <a href="#" class="more-btn">Learn more<i class="far fa-angle-right"></i></a>
                                <div class="details-description">
                                    <p>Demand generation is a constant struggle for any business. Each marketing strategy you employ has generation is a constant struggle for any business. Donec metus lorem, vulputate at sapien sit amet, auctor iaculis lorem. In vel hendrerit nisi. Vestibulum eget risus velit. Aliquam tristique libero at dui sodales, et placerat orci lobortis. Maecenas ipsum neque, elementum id dignissim et, imperdiet vitae mauris. MailChimp is an email marketing service provider founded in 2001. It has 9 million users that collectively send over 15 billion emails through the service each month.</p>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="footer-copyright">
                                <span class="copyright-text">© 2022. All rights reserved by <a href="https://axilthemes.com/">Axilthemes</a>.</span>
                            </div>
                        </div>
                        <div class="col-md-6">
...
<!-- Mirrored from new.axilthemes.com/demo/template/abstrak/onepage-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Jul 2022 15:59:55 GMT -->
</html>