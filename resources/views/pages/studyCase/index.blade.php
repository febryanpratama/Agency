        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title">Services DataTable</h3>
                </div>
                <div class="content-header-right col-md-8 col-12">
                    <div class="breadcrumbs-top float-md-right">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active">Services DataTable
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="heading-elements">
                                        <a href="{{ url('study-case/create') }}">
                                            <button class="btn btn-info">Add Study Case</button>
                                        </a>
                                    </div>
                                </div>
                                            ...
                                            <table class="table table-striped table-bordered base-style text-center">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ url("study-case/".$key->id) }}" class="btn btn-sm btn-warning">
                                                                <i class="ft-edit"></i>
                                                            </a>
        ...
        $('.delete').on('click', function(){
            ...
            $.ajax({
                ...
                success: function(data){
                    console.log(data)
                    if (data.status == true) {
                        swal("Great !", "Study Case Succesfully deleted", "success");
                        setTimeout(() => {
                            location.reload()
                        }, 1500);
                    }
